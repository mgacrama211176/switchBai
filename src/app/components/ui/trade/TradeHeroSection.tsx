    ...
    <section className="min-h-[80vh] w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="w-full max-w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16 relative max-w-5xl mx-auto pt-8 sm:pt-10 md:pt-12">
          {/* Trust Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-lg border mb-4 sm:mb-6 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4 sm:mb-6 tracking-tight relative leading-tight">
            ...
            <div className="absolute -bottom-2 sm:-bottom-4 left-0 lg:left-8 w-8 h-8 sm:w-10 sm:h-10 bg-green-500 rounded-full flex items-center justify-center transform -rotate-12 shadow-lg opacity-80">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-6 sm:mt-8 px-4 sm:px-0">
            <div className="bg-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-full shadow-lg border flex items-center gap-2 sm:gap-3 transform rotate-1 hover:rotate-0 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="bg-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-full shadow-lg border flex items-center gap-2 sm:gap-3 transform rotate-2 hover:rotate-0 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <span className="text-xl sm:text-2xl">🔄</span>
              <div className="text-left">
                <p className="font-bold text-xs sm:text-sm text-gray-900">
                  Flexible Trades
